...
public class TheFaultInOurStarsApp extends Application {
    ...
    public void start(Stage stage) throws Exception {
        Movies TheFaultInOurStars = new Movies("The Fault In Our Stars", "Drama", 13, 5);
        VBox group = new VBox();
        Label nameLabel5 = new Label("Name: " + TheFaultInOurStars.getName());
        Label genreLabel5 = new Label("Genre: " + TheFaultInOurStars.getGenre());
        Label minAgeLabel5 = new Label("Minimum Age: " + TheFaultInOurStars.getMinAge());
        Label movieIdLabel5 = new Label("Movie ID: " + TheFaultInOurStars.getMovieId());
        ImageView posterImageView = new ImageView(new Image("Cinema/The fault IN our Stars.jpg"));
        posterImageView.setFitHeight(200);
        posterImageView.setPreserveRatio(true);
        Button booknow = new Button("Book Now");
        booknow.setStyle("-fx-background-color: #814141; -fx-text-fill: white;");
        booknow.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent e) {
                try {
                    ...
                    alert.setContentText("You are booking: " + TheFaultInOurStars.getName());
                    alert.showAndWait();

                    Label movieName = new Label("Movie: " + TheFaultInOurStars.getName());
                    Label Id = new Label("ID: " + TheFaultInOurStars.getMovieId());
                    ...
                    Confirm.setStyle("-fx-background-color: #814141; -fx-text-fill: white;");
                    ...
                    deleteBooking.setStyle("-fx-background-color: #814141; -fx-text-fill: white;");
        ...
        VBox vbox5 = new VBox(nameLabel5, genreLabel5, minAgeLabel5, movieIdLabel5, booknow);
        vbox5.setSpacing(10);
        vbox5.setAlignment(Pos.CENTER);
        Scene scene = new Scene(vbox5, 400, 250); // Increased the size of the scene
        stage.setScene(scene);
        stage.setTitle("The Fault in Our Stars");
        stage.show();
    }
