...
public class JumanjiApp extends Application {
    ...
    public void start(Stage primaryStage) {
        Movies jumanji = new Movies("Jumanji", "Science Fiction", 12, 1);
        VBox group = new VBox();

        Label nameLabel = new Label("Name: " + jumanji.getName());
        Label genreLabel = new Label("Genre: " + jumanji.getGenre());
        Label minAgeLabel = new Label("Minimum Age: " + jumanji.getMinAge());
        Label movieIdLabel = new Label("Movie ID: " + jumanji.getMovieId());
        ImageView posterImageView = new ImageView(new Image("Cinema/jumanji_poster.jpg"));
        posterImageView.setFitHeight(200);
        posterImageView.setPreserveRatio(true);
        Button booknow = new Button("Book Now");
        booknow.setStyle("-fx-background-color:  #808080; -fx-text-fill: white;");
        booknow.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent e) {
                try {
                    ...
                    alert.setContentText("You are booking: " + jumanji.getName());
                    alert.showAndWait();

                    Label movieName = new Label("Movie: " + jumanji.getName());
                    Label Id = new Label("ID: " + jumanji.getMovieId());
                    Label seatsAvailable = new Label("Seats Available: " + availableSeats);

                    Label Input = new Label("Input Seats to be Reserved:");
                    TextField inputField = new TextField();
                    String seats = inputField.getText();
                    ...
                    Confirm.setStyle("-fx-background-color:  #808080; -fx-text-fill: white;");
                    ...
                    deleteBooking.setStyle("-fx-background-color:  #808080; -fx-text-fill: white;");
        ...
        VBox vbox = new VBox(nameLabel, genreLabel, minAgeLabel, movieIdLabel, booknow);
        vbox.setSpacing(10);
        vbox.setAlignment(Pos.CENTER);
        Scene scene = new Scene(vbox, 400, 250); // Increased the size of the scene
        primaryStage.setScene(scene);
