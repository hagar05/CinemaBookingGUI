...
public class BraveApp extends Application {
    ...
    public void start(Stage stage) throws Exception {
        Movies Brave = new Movies("Brave", "Animation", 8, 7);
        VBox group = new VBox();

        Label nameLabel7 = new Label("Name: " + Brave.getName());
        Label genreLabel7 = new Label("Genre: " + Brave.getGenre());
        Label minAgeLabel7 = new Label("Minimum Age: " + Brave.getMinAge());
        Label movieIdLabel7 = new Label("Movie ID: " + Brave.getMovieId());
        ImageView posterImageView = new ImageView(new Image("Cinema/brave_poster.jpg"));
        posterImageView.setFitHeight(200);
        posterImageView.setPreserveRatio(true);
        Button booknow = new Button("Book Now");
        booknow.setStyle("-fx-background-color: #000080; -fx-text-fill: white; -fx-font-weight: bold;");
        booknow.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent e) {
                try {
                    ...
                    alert.setContentText("You are booking: " + Brave.getName());
                    alert.showAndWait();

                    Label movieName = new Label("Movie: " + Brave.getName());
                    Label Id = new Label("ID: " + Brave.getMovieId());
                    ...
                    Confirm.setStyle("-fx-background-color: #000080; -fx-text-fill: white; -fx-font-weight: bold;");
                    ...
                    deleteBooking
                            .setStyle("-fx-background-color: #000080; -fx-text-fill: white; -fx-font-weight: bold;");
        ...
        VBox vbox7 = new VBox(nameLabel7, genreLabel7, minAgeLabel7, movieIdLabel7, booknow);
        vbox7.setSpacing(10);
        vbox7.setAlignment(Pos.CENTER);

        Scene scene = new Scene(vbox7, 400, 250);
        stage.setScene(scene);
        stage.setTitle("Brave");
        stage.show();
    }
